...
public class LessonListFragmentAdapter extends RecyclerView.Adapter<LessonListFragmentAdapter.LessonListAdapterViewHolder> {
    ...
    @Inject
    public LessonListFragmentAdapter(Context context) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Lessons lesson);
    }
